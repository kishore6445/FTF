-- This migration fixes the foreign key constraint issue in ritual_completions table
...
-- Create a stored procedure to safely add ritual completions
...
BEGIN
  ...
  RETURNING * INTO STRICT id, ritual_id, user_id, date;
